// src/app/[locale]/services/review-translation-standardization/ReviewTranslationStandardizationPageContent.tsx
...
export function ReviewTranslationStandardizationPageContent() {
  const t = useTranslations('ServicesPages.reviewTranslationStandardization');
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="pt-18"> {/* Offset para o header fixo */}
        ...
        <Banner
          title={t('title')}
          backgroundImage="/banners/review-translation-standardization.webp"
        />
        ...
        {/* Steps Section */}
        <Steps serviceKey="reviewTranslationStandardization" />
