// src/app/[locale]/services/layout/LayoutPageContent.tsx
...
export function LayoutPageContent() {
  const t = useTranslations('ServicesPages.layout');
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="pt-18"> {/* Offset para o header fixo */}
        ...
        <Banner
          title={t('title')}
          backgroundImage="/banners/layout.webp"
        />
