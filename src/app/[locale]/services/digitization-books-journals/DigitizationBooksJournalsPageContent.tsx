// src/app/[locale]/services/digitization-books-journals/DigitizationBooksJournalsPageContent.tsx
...
export function DigitizationBooksJournalsPageContent() {
  const t = useTranslations('ServicesPages.digitizationBooksJournals');
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="pt-18"> {/* Offset para o header fixo */}
        ...
        <Banner
          title={t('title')}
          backgroundImage="/banners/digitization-books-journals.webp"
        />
        ...
        {/* Steps Section */}
        <Steps serviceKey="digitizationBooksJournals" />
