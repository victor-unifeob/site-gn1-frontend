// src/app/[locale]/services/html-conversion/HtmlConversionPageContent.tsx
...
export function HtmlConversionPageContent() {
  const t = useTranslations('ServicesPages.htmlConversion');
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="pt-18"> {/* Offset para o header fixo */}
        ...
        <Banner
          title={t('title')}
          backgroundImage="/banners/html-conversion.webp"
        />
        ...
        {/* Steps Section */}
        <Steps serviceKey="htmlConversion" />
