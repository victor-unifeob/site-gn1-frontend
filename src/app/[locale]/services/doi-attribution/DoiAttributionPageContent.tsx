// src/app/[locale]/services/doi-attribution/DoiAttributionPageContent.tsx
...
export function DoiAttributionPageContent() {
  const t = useTranslations('ServicesPages.doiAttribution');
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="pt-18"> {/* Offset para o header fixo */}
        ...
        <Banner
          title={t('title')}
          backgroundImage="/banners/doi-attribution.webp"
        />
        ...
        {/* Steps Section */}
        <Steps serviceKey="doiAttribution" />
