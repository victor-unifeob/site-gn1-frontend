// src/app/[locale]/services/plagiarism-check/PlagiarismCheckPageContent.tsx
...
export function PlagiarismCheckPageContent() {
  const t = useTranslations('ServicesPages.plagiarismCheck');
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="pt-18"> {/* Offset para o header fixo */}
        ...
        <Banner
          title={t('title')}
          backgroundImage="/banners/plagiarism-check.webp"
        />
        ...
        {/* Steps Section */}
        <Steps serviceKey="plagiarismCheck" />
