// src/app/[locale]/services/ebook-epub-mobi-conversion/EbookEpubMobiConversionPageContent.tsx
...
export function EbookEpubMobiConversionPageContent() {
  const t = useTranslations('ServicesPages.ebookEpubMobiConversion');
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="pt-18"> {/* Offset para o header fixo */}
        ...
        <Banner
          title={t('title')}
          backgroundImage="/banners/ebook-epub-mobi-conversion.webp"
        />
        ...
        {/* Steps Section */}
        <Steps serviceKey="ebookEpubMobiConversion" />
