// src/app/[locale]/services/books/BooksPageContent.tsx
...
export function BooksPageContent() {
  const t = useTranslations('ServicesPages.Books');
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="pt-18"> {/* Offset para o header fixo */}
        ...
        <Banner
          title={t('title')}
          backgroundImage="/banners/books.webp"
        />
              ...
              <div className="space-y-8">
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
                      {t('formats.description1')}
                    </p>
                  </div>

                  <div>
                    <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
                      {t('formats.description2')}
                    </p>
                  </div>
                </div>
